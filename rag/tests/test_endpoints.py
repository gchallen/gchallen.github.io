...
def test_embeddings_endpoint():
    ...
    assert embeddings_endpoint, "AZURE_OPENAI_EMBEDDINGS_ENDPOINT environment variable not set"
    assert embeddings_api_key, "AZURE_OPENAI_EMBEDDINGS_API_KEY environment variable not set"
    ...
    assert all(isinstance(x, (int, float)) for x in embedding_vector), "Embedding vector contains non-numeric values"
