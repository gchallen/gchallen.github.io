...
def test_build_time_approach():
    ...
    html_files = list(Path("../html").rglob("*.html"))[:2]  # Just 2 files for faster testing
    ...
    print(f"💡 Ready for production: build index during CI/CD, ship with container, load on startup")
