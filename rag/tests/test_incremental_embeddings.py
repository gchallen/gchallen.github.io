...
def test_incremental_embeddings():
    ...
    print(f"📁 Processing {len(html_files_expanded)} HTML files (including previous ones)...")
    ...
    print(f"\n📊 Performance Summary:")
    print(f"   First build: {len(all_docs_with_meta)} chunks, {new_embeddings} embeddings")
