...
<body>
    ...
    def test_semantic_search_basic(self, client):
        ...
        search_request = {"query": "teaching programming", "k": 3}
    ...
    def test_chat_basic(self, client):
        ...
        chat_request = {"message": "What do you teach?", "session_id": "test_session_1"}
    ...
    def test_clear_session(self, client):
        ...
        if all(
            ...
            chat_request = {"message": "Test message", "session_id": session_id}
            client.post("/chat", json=chat_request)
