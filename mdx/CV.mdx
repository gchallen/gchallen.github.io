...
<div style={{ float: "right", fontSize: "0.8em", marginTop: 8 }}>Updated 4/27/2023</div>
...
Since Fall 2017 I've been a [Teaching Associate Professor](https://cs.illinois.edu/about/people/all-faculty/challen) at the [University of Illinois](https://cs.illinois.edu/).
...
Over 14 semesters at Illinois I have taught a total of 8,962 students^[Including two summers terms].
...
For more details, please review my [teaching statement](https://geoffreychallen.com/statements/teaching).
...
**Enrollment:** 767  
**Format**: Asynchronous online with both online and in-person support, frequent small assessment
...
1. Began work on support for adding support for autograding test suites for all of the 700 questions in our problem library.
...
1. Introduce Kotlin as a language option alongside Java, requiring the development of a parallel set of lessons, homework, and assessments, and project.
...
Please see my [projects page](https://geoffreychallen.com/projects) or my [statement on scholarly activites](https://geoffreychallen/statements/scholarly) for more details.
...
* Autogenerated testing exercises will provide students with the chance to practice writing test suites.
Writing test suites is not only a critical component of software creation, but provides students the opportunity to demonstrate their understanding of a problem, as well as learn to think defensively by anticipate corner cases and problematic inputs.
...
For more details, please review my [service statement](https://geoffreychallen.com/statements/service).
...
* **2022**: [Western Canadian Conference on Computing Education (WCCCE)](https://www.cs.ubc.ca/wccce/): _How the Pandemic (Permanently) Transformed My Teaching_ ([Video](http://www.cs.ubc.ca/wccce/2022-lite/Welcome_Keynote_1/index.html), [Slides](https://docs.google.com/presentation/d/1Z6f66Z_Z5ZbV9qHVpH43vvXzy8PfoFed_StuWya0BwM/edit#slide=id.g101103af8d0_1_0))

* **2022**: [Illinois Computer science Summer Teaching Workshop (iCSTWS)](https://teaching-workshop.cs.illinois.edu/): _All the Reasons for Frequent Small Assessment_ ([Video](https://teaching-workshop.cs.illinois.edu/prior-years/icstws-2022/#:~:text=2%20%E2%80%93%20Part%202-,Session%20Recording,-%3A%0A1%3A00), [Slides](https://docs.google.com/presentation/d/196935rvqKhfpYb4lcSd1slH60nhn9vIOebn4XiLWk0o/edit#slide=id.p))

## Funding

Earlier grants are [listed here](https://www.bluegroup.systems/proposals/).
