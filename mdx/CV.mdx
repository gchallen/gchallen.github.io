...
1. Fully incorporated debugging challenges throughout the daily lessons, alongside a new set of homework problems.
1. Completed work on several new quiz security features, in particular a focus-tracking system that will automatically close a student's assessment when it loses focus more than a configurable number of times.
