...
## CS 199 UAI: Using and Understanding AI ((uai))

[CS 199 UAI](https://www.usingandunderstanding.ai/) is a new course I created for non-technical students at Illinois.
...
* [**Conversational assessments**](https://www.usingandunderstanding.ai/educators): AI-conducted dialogues that replace traditional exams, using a two-agent architecture that separates the interviewer from a hidden evaluator tracking understanding against rubrics
* **Interactive AI demos**: A Digit Recognition Network where students train a neural network from scratch, a Neuron Explorer for adjusting weights and activation functions, and a Markov Babbler for understanding statistical text generation
...
The entire course platform was built through conversational programming with [Claude Code](https://claude.ai/code)—167 sessions, 3,049 conversational turns, and 22,689 tool calls over 47 days. The [full development history](https://www.usingandunderstanding.ai/create) is published transparently.

**Demo**: https://www.usingandunderstanding.ai/
**For Educators**: https://www.usingandunderstanding.ai/educators

## CS 124: AI Integration ((cs124ai))

In Spring 2026, I [rethought CS 124's programming assignments for the AI era](https://www.cs124.org/ai).
Traditional shared assignments—where every student implements the same specification—have been replaced by "My Project," where each student designs and builds their own unique Android application using AI coding agents.
