...
It seems like the pandemic made lecturing cool again, in ways that could set back university education moving forward^[Test a longer footnote with a few different sentences. How about <strong>bold</strong>? Or is it all broken at this point?].
