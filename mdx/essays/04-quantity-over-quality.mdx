...
description: >
   Programming is a skill, and if you want students to get better at it, you need to encourage them to practice.
   A lot.
...
We also included several small programming problems on the weekly quizzes given in our [computer-based testing facility](https://cbtf.engr.illinois.edu/).^[More on this facility soon. It's the single most effective tool I've found for teaching CS1.]
In Fall 2018 students completed 108 small programming problems in both proctored and unproctored environments, writing approximately 14,000 non-commenting lines of code per student, or around 133 lines per student per day over a 15-week semester.
...
I try to write new problems every day.^[Like [Nick Parlante](https://cs.stanford.edu/people/nick/), I'm a reps guy.]
...
[I](-) do think that we should do more with the low-end code quality aspects described above, the ones that we can identify automatically.
...
Reading lots of unfamiliar code is hard enough for inexperienced course staff.
