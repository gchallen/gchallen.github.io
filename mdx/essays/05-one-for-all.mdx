...
description: >
   ...
   The trick to avoiding this is to focus on the things that benefit all students—one for all—and avoid those that only benefit a few students—all for one.
...
But it also accomplishes something even better: It transforms an all-for-one activity (responding to an individual email) into a one-for-all activity (responding to a post on the forum).
...
But I love pretty much everything about how it works—particularly when teaching large courses.
...
Scaling your course does involve foregoing some of that kind of interaction in favor of one-for-all work.
...
So this is hard to justify from our all-for-one versus one-for-all optimization perspective.
But that’s OK!
...
So when I get an unusual or interesting email from a student, I have time to respond fully and thoughtfully.
