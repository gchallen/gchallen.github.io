...
Different people have different talents and abilities that they bring to teaching.
I've been fortunate that the last two decades of my training as a computer scientists have left me with the skills and abilities that I need to create new things for my courses.
...
Talk to a few univeristy computer science educators and you'll quickly hear stories of critical infrastructure running on recycled personal laptops, university mandates requiring the use of poor-quality education technology^[[Piazza](/essays/2021-06-17-why-i-don't-use-piazza), anyone?], institutional resistance to new ideas, and a lot of other barriers to innovation in this space. 
...
All these are examples of great low-cost tools that I have interest in trying to replicate.
They all do one thing, and do it well.
(Just to be clear, my course infrastructure also leverages many more open-source libraries and software tools.)
