...
I moved on to Gatsby and spent a fair amount of time with it, using it to build several websites including my [current course website](https://cs125.cs.illinois.edu/).
