...
This opens up exciting challenges, particularly balancing reinforcement of earlier concepts against ensuring students are making sufficient forward progress.

**Solution-Generated Autograding:** Many programming problem autograders use hand-written tests to examine student code. 
...
Conceptually, it should work just as well on larger assignments, although there are likely to be both technical and conceptual challenges to broadening this approach.
...
Eventually you'll need to apply to the University of Illinois for Fall 2025 admission.
