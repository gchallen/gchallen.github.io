  ...
  return (
    ...
    >
      <div className="messageContent">
        <div className="messageText">{isUser ? message.content : <ReactMarkdown>{message.content}</ReactMarkdown>}</div>
        <div className="messageTime">{new Date(message.timestamp).toLocaleTimeString()}</div>
      </div>
          ...
          {message.sources.map((source, index) => (
            <span key={index} className="source">
              ...
              {source.similarity_score && (
                <span className="similarityScore"> ({Math.round(source.similarity_score * 100)}%)</span>
              )}
  ...
  return (
    <div className="chatContainer">
      ...
      <div className="messagesArea">
        ...
        {hasStartedChat && messages.length > 0 && messages[messages.length - 1].role === "user" && (
        ...
        <div className="inputWrapper">
          <textarea
            ...
            placeholder={
              hasStartedChat
                ? "Reply to Geoffbot..."
                : "Ask me anything about teaching, computer science, or my work..."
            }
            className="input"
            rows={2}
            disabled={isLoading}
          ...
          <div className="buttonColumn">
            ...
            {hasStartedChat && (
              <button onClick={handleClearChat} className="clearButton" type="button">
                Reset
              </button>
            )}
          </div>
        ...
        {!hasStartedChat && (
          <div className="suggestionsSection">
            <div className="suggestions">
              ...
              <div>
                <button
                  onClick={() => sendMessage("What do you think about the future of computer science education?")}
                >
